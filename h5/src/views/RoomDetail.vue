...
.rd__bar{position:fixed;bottom:0;left:0;right:0;z-index:20;padding:14px 16px calc(14px + env(safe-area-inset-bottom));background:rgba(10,14,26,.95);backdrop-filter:blur(20px);border-top:1px solid var(--border-subtle);display:flex;align-items:center;justify-content:space-between}.rd__bar-label{display:block;font-size:11px;color:var(--text-muted)}.rd__bar-price{font-size:24px;font-weight:700;color:var(--neon-cyan)}.rd__bar-price sub{font-size:12px;font-weight:400;color:var(--text-muted)}.rd__book-btn{padding:14px 36px;border-radius:var(--radius-full);font-size:16px;font-weight:700;color:#fff;background:linear-gradient(135deg,var(--neon-cyan),var(--neon-purple));transition:all var(--dur-normal) var(--ease-out)}.rd__book-btn:hover{transform:translateY(-2px);box-shadow:var(--shadow-glow-cyan)}
</style>
